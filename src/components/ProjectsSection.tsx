...
const projects: Project[] = [
    ...
    },
    {
        ...
        description: 'Collaborative task management platform with real-time updates, team workspaces, and analytics dashboard.',
    ...
    {
        title: 'Portfolio CMS',
        description: 'Headless CMS for creative portfolios with dynamic content management and SEO optimization.',
